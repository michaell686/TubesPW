...
<form name="Registrasi" action="" method="POST">
  <div class="container">
    ...
    <input type="text" placeholder="Masukkan username" name="unama" id="unama" required>
    ...
    <input type="password" placeholder="Masukkan Password" name="psw-repeat" id="psw-repeat" required>
    <hr>
...
<?php
	...
	if(mysqli_connect_errno()){
		echo "Koneksi failed ".mysqli_connect_error();
	}
